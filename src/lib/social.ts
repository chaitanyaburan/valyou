...
function buildProjectFeed(): ProjectPost[] {
  const feedData: Array<{ id: string; likes: number; comments: number; timeAgo: string; description: string }> = [
    ...
    { id: "defi-lending-pool", likes: 112, comments: 16, timeAgo: "1d ago", description: "A decentralized lending protocol on Algorand enabling micro-loans with dynamic interest rates. Smart contract passed security audit with zero critical issues." },
...
export const posts: Post[] = [
  ...
  { id: "p6", userId: "anita-desai", userName: "Anita Desai", userAvatar: "AD", username: "@anitadesai", type: "milestone", content: "Mentor Match Platform just crossed 2,100 backers and 2,670 ALGO raised! 89% of goal reached with 5 days left. If you've been on the fence — now is the time.", likes: 267, comments: 38, shares: 45, endorsements: 20, timestamp: "12h ago", timeAgo: "12h", liked: true },
  ...
  { id: "p8", userId: "amit-joshi", userName: "Amit Joshi", userAvatar: "AJ", username: "@amitjoshi", type: "project", content: "Launching today: CI/CD Pipeline Generator — auto-generates GitHub Actions workflows from your repo structure. Backed by 3 years of DevOps experience. Funding goal: 100,000 ALGO.", likes: 203, comments: 29, shares: 33, endorsements: 11, timestamp: "18h ago", timeAgo: "18h", liked: false },
...
export const notifications: Notification[] = [
  { id: "n1", type: "investment", message: "AI Resume Builder price rose +8.3%", detail: "Your holdings gained 16.95 ALGO", timeAgo: "2m ago", read: false, icon: "trending_up" },
  { id: "n2", type: "social", message: "Priya Patel endorsed your project", detail: "Staked 10 ALGO on your credibility", timeAgo: "15m ago", read: false, icon: "thumb_up" },
  ...
  { id: "n5", type: "investment", message: "Buy order filled: 20 shares of CI/CD Pipeline Generator", detail: "Avg price: 38.90 ALGO", timeAgo: "3h ago", read: true, icon: "check_circle" },
  ...
  { id: "n10", type: "alert", message: "Price alert: ScaleDB crossed 22 ALGO", detail: "Your target price was reached", timeAgo: "10h ago", read: true, icon: "notifications" },
