...
export const projects: ProjectStock[] = [
  {
    ...
    sparkline: generateSparkline(42.5, 1), volume: "1.2M ALGO", marketCap: "48.7M ALGO",
  ...
  },
  {
    ...
    sparkline: generateSparkline(28.75, 1), volume: "890K ALGO", marketCap: "31.2M ALGO",
  ...
  },
  {
    ...
    sparkline: generateSparkline(15.2, -1), volume: "2.1M ALGO", marketCap: "15.6M ALGO",
  ...
  },
  {
    ...
    sparkline: generateSparkline(55.8, 1), volume: "3.4M ALGO", marketCap: "89.2M ALGO",
  ...
  },
  {
    ...
    sparkline: generateSparkline(38.9, 1), volume: "1.1M ALGO", marketCap: "42.1M ALGO",
  ...
  },
  {
    ...
    sparkline: generateSparkline(67.3, 1), volume: "1.8M ALGO", marketCap: "64.5M ALGO",
  ...
  },
  {
    ...
    tagline: "Peer-to-peer micro-loans on Algorand",
    creator: getCreator("karan-mehta"),
    price: 8.45, change: -0.18, changePercent: -2.1,
    sparkline: generateSparkline(8.45, -1), volume: "450K ALGO", marketCap: "7.8M ALGO",
    category: "DeFi / Blockchain", tags: ["DeFi", "Algorand", "Lending"],
    ...
    timelineLocked: true,
    batches: [
      { id: "b1", title: "Smart Contract", description: "Lending pool contract on Algorand testnet", deadline: "2026-01-30", completedAt: "2026-01-29", status: "completed", priceImpact: 8 },
      ...
      { id: "b3", title: "Mainnet Deploy", description: "Launch on Algorand mainnet with liquidity", deadline: "2026-05-20", status: "in_progress", priceImpact: 15 },
    ],
    dispute: {
      id: "d1",
  ...
  },
  {
    ...
    sparkline: generateSparkline(22.1, 1), volume: "780K ALGO", marketCap: "18.9M ALGO",
...
export const coupons: Coupon[] = [
  { id: "c1", code: "ALGO-DIAMOND-30", title: "Diamond Tier Reward", discount: "30% off", source: "Portfolio milestone: Diamond staking level", status: "active", expiresAt: "2026-06-30" },
  ...
  { id: "c3", code: "ALGO-EARLY-50", title: "Early Adopter Bonus", discount: "50% off first trade", source: "Early sign-up bonus", status: "used", expiresAt: "2026-03-01" },
  ...
  { id: "c5", code: "ALGO-WEEKLY-10", title: "Weekly Trading Reward", discount: "10% fee waiver", source: "Weekly trading volume milestone", status: "expired", expiresAt: "2026-04-01" },
